function BackscatteredRaysetO = RoxEyeBackScatter(ReflectedRaysO,Normalvecs,ScatterRingRadius,EnvZoom3Value,EnvZoom4Value,EnvZoom5Value)
...
shiftY=(EnvZoom5Value-.5)*20;

STRTcenterpoint=[3.77*sin(angle)+shiftX,-258.52-3.77*cos(angle)+shiftY,0]; %we used 3.77 instead of 3.767 to put the grid a little behind the posterior lens
