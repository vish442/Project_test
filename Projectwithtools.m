...
BottomLoss=0.5
LossFrequencies=99999999:99999999+1
...
%         'PropagationSpeed',Speed);
    ...
    hydrophone = phased.IsotropicHydrophone('FrequencyRange',[99999999 99999999+1],...  %set up Hydrophone with the same frequency range as the sound projector and approiate voltage 
    ...
    'NumElements',3,'ElementSpacing',Speed/fc/2,...
    'ArrayAxis','x');
    ...
    numTransmits = 10;
    rxsig = zeros(size(x,1),3,numTransmits);
