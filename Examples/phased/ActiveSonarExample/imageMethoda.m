function [rcvAng,srcAng,pathLength,numRefl,TxPosImage,TxVelImage]=imageMethoda(ChannelDepth,TxPos,TxPos1,RxPos,TxVel,numPaths)
...
dXYY=norm(TxPos1(1:2)-RxPos(1:2),2);
